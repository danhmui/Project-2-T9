            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="formContact">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Họ và tên" id="fullName" name="fullname">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Email" name="email">
                            </div>
                        </div>
                        <input type="text" class="form-control mt-3" placeholder="Số điện thoại" id="phone" name="phone">
                        <input type="text" class="form-control mt-3" placeholder="Nội dung" name="demand">
                        <button id="btnSubmit" class="btn btn-primary px-4 mt-3">
                            Gửi liên hệ
                        </button>
        ...
        $('#btnSubmit').click(function (e){
            ...
            $.ajax({
                ...
                success: function (response){
                    showAlert("Liên hệ thành công!", "success");
                },
